...
/// <summary>
/// Provides extension methods for converting an option to a nullable value.
/// </summary>
public static class AsNullableExtensions
{
    // ReSharper disable once InvalidXmlDocComment
    /// <summary>
    /// Convert the <see cref="Nullable"/> back to a <see cref="T?"/> object.
    /// </summary>
    /// <remarks>This is mostly useful for ORM's like EF Core that must work with nullable types </remarks>
    /// <returns>Returns the <see cref="Option{TValue}"/> equivalent to the <see cref="Option"/>.</returns>
