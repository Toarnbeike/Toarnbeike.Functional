...
public class ResultTValueTests
{
    ...
    public void TryGetValue_ShouldReturn_Value_WhenResultIsFailure()
    {
        ...
        result.TryGetContents(out var actualValue, out _).ShouldBeTrue();
    ...
    public void TryGetValue_ShouldReturn_Failure_WhenResultIsFailure()
    {
        ...
        result.TryGetContents(out _, out var failure).ShouldBeFalse();
    ...
    [Fact]
    public void ToString_Should_ReturnSuccess_WhenResultIsSuccess()
    {
    ...
    [Fact]
    public void ToString_Should_ReturnFailureOfType_WhenResultIsFailure()
    {
        var result = Result.Failure(_testFailure);
        result.ToString().ShouldBe("Failure(Failure)");
    }
}